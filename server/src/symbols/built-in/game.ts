...
export const gameSymbols: BaseSymbolType = {
  ...
  subSymbols: [
    ...
    },
    {
      ...
      description:
        "Returns the current PVP setting (in misc). 0 - Off, 1 - FFA, 2 - Teams.",
    },
    {
      name: "EndTimeLeft",
      kind: CompletionItemKind.Property,
    ...
    },
    {
      ...
      description:
        'Spawn a titan. Master client only. Valid types: "Default", "Dummy", "Normal", "Abnormal", "Punk", "Crawler".',
    },
    {
      name: "SpawnTitanAt",
      kind: CompletionItemKind.Method,
    ...
    },
    {
      ...
      kind: CompletionItemKind.Method,
      detail:
        "function SpawnTitansAt(type:string, amount: int, position: Vector3): List(Titan)",
    ...
    },
    {
      ...
      kind: CompletionItemKind.Method,
      detail:
        "function SpawnShifterAt(type: string, position: Vector3): Shifter",
    ...
    },
    {
      ...
      kind: CompletionItemKind.Method,
      detail:
        "function SpawnPlayerAt(player: Player, force: bool, position: Vector3)",
    ...
    },
    {
      ...
      kind: CompletionItemKind.Method,
      detail:
        "function SpawnProjectile(projectile: string, position: Vector3, rotation: Vector3, velocity: Vector3, gravity: Vector3, liveTime: float, team: string, [extra params])",
    ...
    },
    {
      ...
      kind: CompletionItemKind.Method,
      detail:
        "function SpawnProjectileWithOwner(projectile: string, position: Vector3, rotation: Vector3, velocity: Vector3, gravity: Vector3, liveTime: float, owner: Character, [extra params])",
    ...
    },
    {
      ...
      kind: CompletionItemKind.Method,
      detail:
        "function SpawnEffect(effect: string, position: Vector3, rotation: Vector3, scale: float, [params])",
