...
const QuaternionBuiltin = createBuiltinExtension(
  "Quaternion",
  ["Identity"],
...
const TimeBuiltin = createBuiltinExtension(
  "Time",
  ["TickTime", "GameTime", "FrameTime", "TimeScale"],
  []
);
...
const InputBuiltin = createBuiltinExtension(
  "Input",
  [],
  ["GetKeyName", "GetKeyHold", "GetKeyDown", "GetKeyUp", "GetMouseAim"]
);
...
const CutsceneBuiltin = createBuiltinExtension(
  "Cutscene",
  [],
  ["Start", "ShowDialogue", "HideDialogue"]
);
...
const RoomDataBuiltin = createBuiltinExtension(
  "RoomData",
  [],
  ["SetProperty", "GetProperty", "Clear"]
);
const PersistentDataBuiltin = createBuiltinExtension(
  "PersistentData",
  [],
  ["SetProperty", "GetProperty", "Clear", "SaveToFile", "LoadFromFile"]
);
const JsonBuiltin = createBuiltinExtension(
  "Json",
  [],
  ["LoadFromString", "SaveToString"]
);
const PhysicsBuiltin = createBuiltinExtension(
  "Physics",
  [],
  ["LineCast", "SphereCast"]
);
